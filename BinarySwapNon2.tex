...
Nonaka \etal\scite{Nonaka2015,Nonaka2018} propose \ttfcomposite to roll the reduction into the first iteration of the binary swap algorithm.
...
Moreland \etal\scite{Moreland2011:SC} propose the \telescoping algorithm.
...
\fix{Direct Send} \fix{SLIC as a varient of that}
