...
\end{wrapfigure}
time taken to build the compositing tree, which is complex for \ttswap and has to take into account all the processes.
...
\vfill % Putting URL on bottom of page happens to work out well.
\iftoggle{anonymous}{
