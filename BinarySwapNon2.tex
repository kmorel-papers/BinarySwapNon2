...
This measurement suggests that overall rendering throughput will be maximized by leveraging shared-memory local rendering, of which there are many choices \fix{cite: OspRAY, OpenSWR, Larsen, VTK-m?}, to reduce the number of MPI processes on each physical node.
