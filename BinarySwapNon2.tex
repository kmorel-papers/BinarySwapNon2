...
A third observation is that the \ttswap algorithm behaves well up to 1024 processes (which is as large as was measured by Ye et al.\scite{23Swap}), but the performance starts to deteriorate on larger sizes, particularly for the HDTV images.
...
Figure \ref{fig:VNvsSMPHDTV} shows the comparison between running on virtual node and pure distributed for generating HDTV images.
